...
module.exports = {
    name: 'remove',
    description: 'Eliminar dinero u objetos de un usuario',
    execute(message, args, { moderador }) {
        ...
        switch (args[0]) {
            case 'money': {
                ...
                moderador.removeMoneyFromUser(targetUser.id, amount, type);
                return message.reply({
                    embeds: [
                        new EmbedBuilder()
                            .setColor('#FFA500')
                            .setTitle('Dinero eliminado')
                            .setDescription(`Se han eliminado 💵 ${amount} del **${type}** de ${targetUser.username}.`)
                            .setFooter({ text: 'Moderación' })
                            .setTimestamp()
                    ]
                });
            ...
            case 'item': {
                ...
                moderador.removeItemFromUser(targetUser.id, itemId, amount);
                return message.reply({
                    embeds: [
                        new EmbedBuilder()
                            .setColor('#FFA500')
                            .setTitle('Objeto eliminado')
                            .setDescription(`Se han eliminado ${amount}x del objeto **${itemId}** de ${targetUser.username}.`)
                            .setFooter({ text: 'Moderación' })
                            .setTimestamp()
                    ]
                });
